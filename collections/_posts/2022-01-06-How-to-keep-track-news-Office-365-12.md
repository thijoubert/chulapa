...
Step 10: For the [Office 365 blog](https://techcommunity.microsoft.com/t5/office-365-blog/bg-p/Office365Blog), I get the RSS feeds of the previous day : "addDays(utcnow(),-1)".
...
Step 6: Definition of the URI of the graph request: " https://graph.microsoft.com/beta/admin/serviceAnnouncement/messages?$filter=lastModifiedDateTime ge @{addDays(utcnow(),-1)} ".
